...
sails.log.info(`Arduino - Successfully connected to MQTT: OK7`);
    if (IDENTIFIERS_REG_EXP.test(topic)) {
        try {
            ...
            let identifiers = IDENTIFIERS_REG_EXP.exec(topic);

            gladys.device.getByIdentifier(
                {
                    identifier: identifiers[1],
                    service: 'mqtt-arduino'
                }
...
sails.log.info(`Arduino - Successfully connected to MQTT: OK8`);
};
