...
sails.log.info(`Arduino - Successfully connected to MQTT: ${params.deviceType.value}`);
sails.log.info(`Arduino - Successfully connected to MQTT: ${params.deviceType.deviceTypeValue}`);

sails.log.info(`Arduino - Successfully connected to MQTT: ${params.deviceType}`);
sails.log.info(`Arduino - Successfully connected to MQTT: ${params.deviceType.deviceValue}`);
sails.log.info(`Arduino - Successfully connected to MQTT: ${params.deviceType.device.Value}`);
};
